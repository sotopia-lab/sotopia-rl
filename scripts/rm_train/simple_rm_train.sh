...
CUDA_VISIBLE_DEVICES=2 python /data/haofeiy2/sotopia-rl/sotopia-rl/train_rm.py \ --model_name /data/models/gemma-2-2b-it \ --learning_rate 1e-5 \ --max_length 4096 \ --train_batch_size 1 \
--val_batch_size 4 \
--accumulation_steps 4 \
--num_epochs 3 \
