CUDA_VISIBLE_DEVICES=7,8 accelerate launch \
  ...
  --gamma 0.99 \
  --lam 0.95 \
  --output_dir /data/haofeiy2/sotopia-rl/ppo_qwen25_7b_reward_direct_default_no_goal_gpt-4o_without_goal_leak_with_sft_self_play_data_use_sotopia_pi_full_data_v1PPOTrainer