...
export REJ_SAMPLING_NUM=10
export SFT_MODEL_FOLDER_NAME="sft_qwen25_7b"
export RM_FOLDER_NAME="rm_reward_direct_normalized_no_goal_gpt-4o"
export REPO_FOLDER_NAME="/data/haofeiy2/sotopia-rl"
export SFT_MODEL_PATH="${REPO_FOLDER_NAME}/${SFT_MODEL_FOLDER_NAME}/checkpoint-1000/"
export RM_MODEL_PATH="${REPO_FOLDER_NAME}/${RM_FOLDER_NAME}/checkpoint-6400"


export TAG="${RM_FOLDER_NAME}_rej_sampling_num${REJ_SAMPLING_NUM}_vs_${SFT_MODEL_FOLDER_NAME}-0324-v2"
