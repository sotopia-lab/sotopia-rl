...
'--gin.BATCH_SIZE=1' \
'--gin.PUSH_TO_DB=True' \
'--gin.TAG="sotopia_rejection-sampling-rm-baselin-and-sft_vs_sotopia_gemma-2-2b-it-sft-1107_sample_1"'
...
'--gin.BATCH_SIZE=1' \
'--gin.PUSH_TO_DB=True' \
'--gin.TAG="sotopia_rejection-sampling-rm-baselin-and-sft_vs_sotopia_gemma-2-2b-it-sft-1107_sample_5"'
...
'--gin.BATCH_SIZE=1' \
'--gin.PUSH_TO_DB=True' \
'--gin.TAG="sotopia_rejection-sampling-rm-baselin-and-sft_vs_sotopia_gemma-2-2b-it-sft-1107_sample_10"'
