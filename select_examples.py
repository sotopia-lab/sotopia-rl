...
# print(episodes[0]['experiment_model_name_pairs'])
...
qualifying_episodes = []
for episode in episodes:
    if (episode['rewards'][0]['goal'] >= 8 or episode['rewards'][0]['goal'] <= 2) and \
       (episode['rewards'][1]['goal'] >= 8 or episode['rewards'][1]['goal'] <= 2) and \
           (episode['social_interactions'].count('said:') > 2) and \
               (episode['experiment_model_name_pairs'][1] == 'gpt-4' or episode['experiment_model_name_pairs'][1] == 'gpt-3.5-turbo') and \
                   (episode['experiment_model_name_pairs'][2] == 'gpt-4' or episode['experiment_model_name_pairs'][2] == 'gpt-3.5-turbo'):
