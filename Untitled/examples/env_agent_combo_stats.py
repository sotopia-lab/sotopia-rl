...
all_env_agent_combos = EnvAgentComboStorage().all()
env_agent_combos = defaultdict(list)
for combo in all_env_agent_combos:
    if combo.env_id in env_ids:
        env_agent_combos[combo.env_id].append(combo.agent_ids)
