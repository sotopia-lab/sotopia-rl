...
--chat-template /root/sotopia-rl/Untitled/qwen2.5-7b.jinja \
--enable-lora \
--lora-modules sotopia-sft=/root/sotopia-rl/Untitled/.cache/final_sft/checkpoint-500 \
...
'--gin.BATCH_SIZE=20' \
'--gin.PUSH_TO_DB=True' \
'--gin.TAG="sotopia-sft-gpt-3-21-v5"'
