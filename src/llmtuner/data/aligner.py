...
def convert_alpaca(
    ...
    outputs = {"prompt": [], "response": [], "system": [], "tools": [], "images": [], "values": []}
    ...
    for i in range(len(examples[dataset_attr.prompt])):
        ...
        outputs["values"].append(examples[dataset_attr.value][i] if dataset_attr.value else 0)
    ...
    features = Features.from_dict(
        {
            ...
            "values": {"dtype": "float", "_type": "Value"},
            "images": [{"_type": "Image"}],
        }
    )
    kwargs = {}
